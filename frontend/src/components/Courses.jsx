...
function Courses() {
  ...
  return (
    <div className="courses-container m-0">
      ...
      {editCourse && <EditCourseForm editCourse={editCourse} setEditCourse={setEditCourse} />}
      {editSection && <EditSectionForm editSection={editSection} setEditSection={setEditSection} selectedCourse={selectedCourse} />}
      {editLesson && <EditLessonForm editLesson={editLesson} setEditLesson={setEditLesson} selectedCourse={selectedCourse} selectedSection={selectedSection} />}
      {editQuiz && <EditQuizForm editQuiz={editQuiz} setEditQuiz={setEditQuiz} selectedCourse={selectedCourse} selectedSection={selectedSection} />}
    </div>
  );
}
